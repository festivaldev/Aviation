                ...
                <div class="section-content row reversed">
                    <aside class="column column-3">
                        ...
                        <ul class="sc-menu contents">
                            ...
                            <%
                                // Add sidebar entry for each question

                                while (questions.next()) {
                            %>

                            <a data-q-link="<%= questions.getString("linkId") %>" class="menu-item">
                                <li><%= questions.getString("questionText") %></li>
                            </a>

                            <%
                                }

                                // Return before the first statement to allow re-iteration
                        ...
                        <ul class="sc-menu">
                            ...
                            <a href="sc-index.jsp" class="menu-item selected">
                                <li>FAQ</li>
                            </a>
                    ...
                    <div class="column column-8 offset-1">
                        ...
                        <%
                            // Display a card for each question/answer pair
                        ...
                        <%
                                ...
                                // Display an error flag if no questions could be loaded
                        %>
