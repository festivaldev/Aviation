<!--
    ...
    Checkout bookings by "fake paying" with any credit card details
    Using "4000 0027 6000 0016" as card number the payment will fail for demonstration purposes
        ...
        if (invoiceData.next()) {
            if (invoiceData.getBoolean("paid")) {
                ...
                if (request.getMethod().equals("POST")) {
                    // If the request is a POST request, perform the payment
                    ...
                    if (holder == null || holder.isEmpty() || number == null || number.isEmpty() || expiration == null || expiration.isEmpty() || cvv == null || cvv.isEmpty()) {
                        ...
                        if (number.equals("4000 0027 6000 0016")) {
                            // Let the payment fail for demonstration
                            paymentError = true;
                        } else {
                            // Let the payment succeed

                            // Update booking and set paid to true
                ...
                <div class="section-content">
                    ...
                    <article class="flag error">
                        <div class="header">
                            ...
                            <span class="title">Rechnung existiert nicht</span>
                        </div>
                        <div class="content">
                    ...
                    <article class="flag error">
                        <div class="header">
                            <div class="icon"><span><span class="ai ai-error"></span></span></div>
                            <span class="title">Rechnung bereits bezahlt</span>
                        </div>
                        <div class="content">
                    ...
                    <%
                        ...
                        // Only show the invoice and payment markup when a valid and non-paid invoice is given
                    ...
                    <div class="container">
                        ...
                        <article class="card-input">
                            <form method="POST" action="checkout.jsp" novalidate>
                                ...
                                <%
                                    // Only show input if payment hasn't been done (regardless of the result of the payment)
