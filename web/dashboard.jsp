			...
			<section class="dashboard">
				...
				<div style="margin-bottom: 2em" class="section-content">
					...
					<article class="flag success">
						<div class="header">
							<div class="icon"><span><span class="ai ai-success"></span></span></div><span class="title">Profil aktualisiert</span>
						</div>
						<div class="content">
					...
					<article class="flag success">
						<div class="header">
							<div class="icon"><span><span class="ai ai-success"></span></span></div><span class="title">Passwort aktualisiert</span>
						</div>
						<div class="content">
					...
					<article class="flag success">
						<div class="header">
							<div class="icon"><span><span class="ai ai-success"></span></span></div><span class="title">Rechnungsadresse aktualisiert</span>
						</div>
						<div class="content">
					...
					<article class="flag error">
						<div class="header">
							<div class="icon"><span><span class="ai ai-error"></span></span></div><span class="title">Passwort falsch</span>
						</div>
						<div class="content">
					...
					<article class="flag error">
						<div class="header">
							<div class="icon"><span><span class="ai ai-error"></span></span></div><span class="title">Passwörter ungleich</span>
						</div>
						<div class="content">
				...
				<div class="section-content row">
					<div class="column column-3">
						<ul class="user-cp-menu">
							<li class="menu-item heading">Allgemein</li><a href="?p=profile" class="menu-item <%= isCurrentPage(request.getParameter("p"), "profile") ? "selected" : "" %>">
								<li>Profil</li></a><a href="?p=billing" class="menu-item <%= isCurrentPage(request.getParameter("p"), "billing") ? "selected" : "" %>">
								<li>Rechnungsadresse</li></a>
						</ul>
						<ul class="user-cp-menu">
							<li class="menu-item heading">Buchungen</li><a href="?p=openBookings" class="menu-item <%= isCurrentPage(request.getParameter("p"), "openBookings") ? "selected" : "" %>">
								<li>Offene Buchungen</li></a><a href="?p=completedBookings" class="menu-item <%= isCurrentPage(request.getParameter("p"), "completedBookings") ? "selected" : "" %>">
								<li>Abgeschlossene Buchungen</li></a>
						</ul><% if (isAdmin) { %>
						<ul class="user-cp-menu">
							<li class="menu-item heading">Administration</li><a href="sc-admin.jsp" class="menu-item">
								<li>Support Center Admin Panel</li></a>
						</ul><% } %>
						<ul class="user-cp-menu"><a href="?p=logout" class="menu-item">
								<li>Abmelden</li></a></ul>
					</div><% if (isCurrentPage(request.getParameter("p"), "profile")) { %>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<%= String.format("%.2f", price) %>€<br><a href="checkout.jsp?invoice=<%= invoice %>" target="_blank" style="white-space: nowrap">Jetzt bezahlen</a>
									</td>
