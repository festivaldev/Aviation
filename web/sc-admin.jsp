<!--
    ...
    Admin panel for the questions from the support center
...
<%
    ...
    // If there is no user logged in or the user isn't an admin, redirect to login
                ...
                <div class="section-content">
                    ...
                    <article class="flag success">
                        <div class="header">
                            ...
                            <span class="title">Aktion erfolgreich</span>
                        </div>
                        <div class="content">
                    ...
                    <article class="flag info">
                        <div class="header">
                            <div class="icon"><span><span class="ai ai-info"></span></span></div>
                            <span class="title">Information zu Fragen</span>
                        </div>
                        <div class="content">
